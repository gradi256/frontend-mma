      ...
      <div className="relative w-full lg:w-[40%] min-h-[40vh] lg:min-h-screen flex flex-col justify-center p-8 lg:p-12 overflow-hidden">
        ...
        <div className="relative z-10 space-y-4 max-w-sm">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent/20 border border-accent/30 backdrop-blur-md">
            ...
            <span className="text-xs font-semibold text-white tracking-wide uppercase">Espace Passionné</span>
          </div>
          ...
          <p className="text-sm text-zinc-200 leading-relaxed">
            Connectez-vous pour suivre vos commandes, échanger avec vos artisans favoris et découvrir les nouveautés en exclusivité.
          </p>
        </div>
      </div>
          ...
          <div className="flex flex-col items-center lg:items-start space-y-4 mb-10">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-muted-foreground mt-2 text-sm">
                {view === "login" && "Saisissez vos accès pour retrouver vos œuvres et paniers."}
          ...
          {view === "login" && (
            <div className="mt-8 pt-6 border-t border-border/50 text-center">
              <p className="text-sm text-muted-foreground">
                ...
                <NavLink to="/auth/auth-register/client" className="text-primary font-bold hover:underline underline-offset-4">
